...
type ModuleGenerator = () => interfaces.ContainerModule;
interface AxModule {
    getModule(): interfaces.ContainerModule;
}

type ModuleGeneratorAsync = () => interfaces.AsyncContainerModule;
interface AxModuleAsync {
    getModule(): interfaces.AsyncContainerModule;
}

export { AxModule, AxModuleAsync, ModuleGenerator, ModuleGeneratorAsync };
